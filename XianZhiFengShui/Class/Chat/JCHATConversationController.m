...
@interface JCHATConversationController (){
@private
...
@implementation JCHATConversationController
...
- (void)viewDidLayoutSubviews {
    NSLog(@"Event - viewDidLayoutSubviews");
    [self scrollToBottomAnimated:NO];
}

- (void)viewWillDisappear:(BOOL)animated {
    NSLog(@"Event - viewWillDisappear");
...
- (void)addtoolbar {
    ...
    self.toolBarContainer.frame = CGRectMake(0, SCREENHEIGHT-45, SCREENWIDTH, 45);
    [self.view addSubview:self.toolBarContainer];
    
    self.toolBarContainer.toolbar = NIB(JCHATToolBar);
...
- (void)setupComponentView {
    ...
    _messageTableView = [[JCHATMessageTableView alloc]initWithFrame:CGRectMake(0, XZFS_STATUS_BAR_H, SCREENWIDTH, SCREENHEIGHT-XZFS_STATUS_BAR_H-45)];
...
- (void)setupNavigation {
    self.titelLab.text = _conversation.title;
...
- (void)prepareImageMessage:(UIImage *)img {
    NSLog(@"Action - prepareImageMessage");
